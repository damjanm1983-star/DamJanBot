...
def run_dashboard_server(port=6000):
    ...
    logger.info(f"📊 Dashboard on http://153.75.244.71:{port} (proxied via nginx on 8080)")
    server.serve_forever()
...
if __name__ == "__main__":
    ...
    logger.info("Webhook: http://153.75.244.71/webhook")
    logger.info("Dashboard: http://153.75.244.71:8080 (→ proxied to port 6000)")
    logger.info("API Status: http://153.75.244.71:8080/api/status")
    logger.info("=" * 60)
